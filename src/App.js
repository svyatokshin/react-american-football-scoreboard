...
function App() {
  ...
  let homeTouchdown = event => {setHomeCount(homeCount +7)};
  let homeFieldgoal = event => {setHomeCount(homeCount + 3)};

  let awayTouchdown = event => {setAwayCount(awayCount + 7)};
  let awayFieldgoal = event => {setAwayCount(awayCount + 3)};
  return (
